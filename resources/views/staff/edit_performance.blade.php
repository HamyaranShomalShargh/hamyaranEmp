            ...
            <div class="table-responsive p-3">
                <table id="search_table" class="table table-striped static-table" data-filter="[0,1]" v-cloak>
                    ...
                    <tr v-for="item in table_data_records.performance_automation.performances">
                        ...
                        <td v-for="(attribute,index) in table_data_records.performance_automation.attributes.items" style="min-width: 90px"><input class="form-control iranyekan text-center" :type="attribute['kind']" min="0" :value="get_employee_performance_value(item.employee.id,index)" v-on:input="set_employee_performance_value($event,item.employee.id,index)"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
