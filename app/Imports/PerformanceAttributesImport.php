...
class PerformanceAttributesImport implements ToArray,SkipsOnFailure,WithEvents,WithStartRow,SkipsEmptyRows
{
    ...
    public function array(array $array)
    {
        ...
        $contract_subset->update(["performance_attributes" => json_encode($data,JSON_UNESCAPED_UNICODE)]);
    }
