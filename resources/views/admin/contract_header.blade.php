        ...
        <div class="w-100 content-window bg-menu rounded border">
            ...
            <div class="page-header">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control text-center iranyekan" data-table="main_table" placeholder="جستجو با نام سرفصل" v-on:input="filter_table">
                    <div class="input-group-prepend">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($contract_header->files)
                                    <a href="{{ route("AdminContractHeader.download",$contract_header->id) }}"><i class="fa fa-download fa-1-6x"></i></a>
                                @else
                            ...
                            <td>
                                <div class="dropdown table-functions iranyekan">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <form class="w-100" id="activation-form-{{ $contract_header->id }}" action="{{ route("AdminContractHeader.activation",$contract_header->id) }}" method="POST" v-on:submit="submit_form">
                                            @csrf
                                        ...
                                        <a role="button" href="{{ route("AdminContractHeader.edit",$contract_header->id) }}" class="dropdown-item">
                                            <i class="fa fa-edit"></i>
                                            <span class="iranyekan">ویرایش</span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <form class="w-100" id="delete-form-{{ $contract_header->id }}" action="{{ route("AdminContractHeader.destroy",$contract_header->id) }}" method="POST" v-on:submit="submit_form">
                                            @csrf
                                            @method("Delete")
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="main_submit_form" class="p-3" action="{{ route("AdminContractHeader.store") }}" method="POST" enctype="multipart/form-data" v-on:submit="submit_form">
                        @csrf
                        <div class="form-row">
