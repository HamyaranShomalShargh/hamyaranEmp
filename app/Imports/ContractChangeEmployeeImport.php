...
class ContractChangeEmployeeImport implements OnEachRow,WithValidation,SkipsOnFailure,WithEvents,WithStartRow,SkipsEmptyRows
{
    ...
    {
        $employee = Employee::query()->where("national_code" ,"=", $row[0])->first();
        $employee?->update(["contract_subset_id" => $this->contract_subset_id]);
    }
