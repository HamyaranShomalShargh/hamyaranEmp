...
@section('content')
    <div class="page pt-3">
        <div class="w-100 content-window bg-menu rounded border">
            ...
            <form id="main_submit_form" class="p-3" action="{{ route("ContractHeader.update",$contract_header->id) }}" method="POST" enctype="multipart/form-data" v-on:submit="submit_form">
                @csrf
                @method('PUT')
                <div class="form-row">
