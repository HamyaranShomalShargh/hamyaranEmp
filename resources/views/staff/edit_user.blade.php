...
@section('content')
    <div class="page pt-3">
        <div class="w-100 content-window bg-menu rounded border">
            ...
            <form id="update_form" class="p-3" action="{{ route("StaffUsers.update",$user->id) }}" method="POST" enctype="multipart/form-data" v-on:submit="submit_form">
                @csrf
                @method('PUT')
                <div class="form-row">
                    ...
                    <div class="form-group col-12 form-button-row text-center pt-4 pb-2">
                        ...
                        <a role="button" href="{{ route("StaffUsers.index") }}" class="btn btn-outline-secondary iranyekan" data-dismiss="modal">
