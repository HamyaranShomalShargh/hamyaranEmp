...
@section('content')
    <div class="page pt-3">
        <div class="w-100 content-window bg-menu rounded border">
            ...
            <div class="page-header">
                <div class="input-group">
                    <div class="input-group-prepend" style="border-radius: 0">
                        <a href="{{ route("MakePerformance.performance_export_excel",$contract_subset->id) }}" class="btn btn-outline-info mr-2" style="border-radius: 0.25rem">
            ...
            <form id="main_submit_form" class="p-3" action="{{ route("MakePerformance.store") }}" data-json="employees_data" method="post" v-on:submit="submit_form">
                @csrf
                @method('put')
                <input type="hidden" id="employees_data" name="employees_data">
                <input type="hidden" name="authorized_date_id" value="{{$authorized_date["id"]}}">
                <div class="form-row">
                    <div class="form-group col-12">
                        <select class="form-control text-center iranyekan mr-2 @error('user_id') is-invalid @enderror selectpicker rtl" title="کاربر ثبت کننده اتوماسیون" name="user_id" data-container="body" size="5" data-live-search="true">
                            @forelse($contract_subset->users as $user_c)
            ...
            <div class="w-100 form-button-row text-center pt-4 pb-4 position-sticky" style="z-index: 1000;bottom: 0">
                ...
                <a role="button" href="{{ route("MakePerformance.index") }}" class="btn btn-outline-secondary iranyekan" data-dismiss="modal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <axios-button :class="'btn btn-outline-primary'" :route="'{{ route("MakePerformancePreImport") }}'" :action="'load'" :required="['#upload_file']" :elements="['#upload_file','#contract_id']"  :message="'آیا برای بارگذاری فایل کارکرد اطمینان دارید؟'">
