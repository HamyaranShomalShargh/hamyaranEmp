                        ...
                        <tr>
                            ...
                            <td>
                                @if($contract_subset->files)
                                    <a href="{{ route("AdminContractSubset.download",$contract_subset->id) }}"><i class="fa fa-download fa-1-6x"></i></a>
                                @else
                            ...
                            <td>
                                <div class="dropdown table-functions iranyekan">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <form class="w-100" id="activation-form-{{ $contract_subset->id }}" action="{{ route("AdminContractSubset.activation",$contract_subset->id) }}" method="POST" v-on:submit="submit_form">
                                            @csrf
                                        ...
                                        <a role="button" href="{{ route("AdminContractSubset.edit",$contract_subset->id) }}" class="dropdown-item">
                                            <i class="fa fa-edit"></i>
                                            <span class="iranyekan">ویرایش</span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <form class="w-100" id="delete-form-{{ $contract_subset->id }}" action="{{ route("AdminContractSubset.destroy",$contract_subset->id) }}" method="POST" v-on:submit="submit_form">
                                            @csrf
                                            @method("Delete")
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="main_submit_form" class="p-3" action="{{ route("AdminContractSubset.store") }}" method="POST" enctype="multipart/form-data" v-on:submit="submit_form">
                        @csrf
                        <div class="form-row">
