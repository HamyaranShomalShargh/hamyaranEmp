    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="login-box pt-3 pb-4 pr-3 pl-3 rtl">
                <form id="login_form" autocomplete="off" method="POST" action="{{ route('password.update.sms') }}" v-on:submit="show_loading = true">
                    @csrf
                    ...
                    <span class="form-control login-input-text iranyekan">{{ $mobile }}</span>
