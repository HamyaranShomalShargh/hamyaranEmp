...
class ContractChangeEmployeeExport extends StringValueBinder implements FromView,WithStyles,WithEvents,WithTitle,WithProperties
{
    ...
    {
        return view('excel.contract_change_employees');
    }

    public function title(): string
    {
        return "لیست پرسنل جهت تغییر قرارداد";
    }
